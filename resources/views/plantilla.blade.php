                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="modal" id="modal-categoria" tabindex="-1" >
                            <div class="modal-dialog" style="font-weight:bold;  background-color:#ffda9e">
                                <div class="modal-content" style="font-weight:bold;  background-color:#ffda9e">
                                    <div class="modal-header" style="font-weight:bold;  background-color:#ffda9e">
                                        <h5 class="modal-title" style="font-weight:bold;" >Crear Categoría</h5>
